...
``` R
> rtw::search_tweets(
     "lang:en filter:verified min_retweets:1000",
     n = 200,
     include_rts = FALSE
  )
..downloading..    ―――――――――――――――――――――――――――――――――――――――――――――――――――――   1s
...
2  2021-11-01 13:11:05    AdamSchefter    Titans’ RB Derrick Henry suff...   .
3  2021-11-01 13:50:47    AdamSchefter    The concern on Titans’ RB Der...   .
...
7  2021-11-01 15:47:42         LilNasX    wall street journal https://t...   .
8  2021-11-01 11:15:24    narendramodi    Heartiest felicitations to @k...   .
9  2021-11-01 15:24:32    narendramodi    Will be addressing the @COP26...   .
10 2021-11-01 15:47:07    narendramodi    The @COP26 Summit offers a wo...   .
   ...
```